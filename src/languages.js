// Complete list of NLLB-200 supported languages
// Format: { code: 'FLORES-200 code', name: 'Language Name' }
...
export const languages = [
  ...
  { code: 'lvs_Latn', name: 'Standard Latvian' },
...
// Popular languages (top 25 by number of speakers and usage)
